...
//
//class BuildingMap(
//                   val wallsPoints: List[Point],
//                   val smellOrigins: Array[Point],
//                   val exits: Array[(Point, EvacuationDirectionSmellStrength, Int)],
//                   val people: Array[PointPair],
//                   val teleportationPairs: Array[PointPair]
//                 ) { }
